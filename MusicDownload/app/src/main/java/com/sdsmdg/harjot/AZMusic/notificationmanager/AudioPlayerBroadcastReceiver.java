package com.sdsmdg.harjot.AZMusic.notificationmanager;
...
public class AudioPlayerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equalsIgnoreCase("com.sdsmdg.harjot.AZMusic.ACTION_PLAY_PAUSE")) {
            try {
        ...
        } else if (action.equalsIgnoreCase("com.sdsmdg.harjot.AZMusic.ACTION_NEXT")) {
        ...
        } else if (action.equalsIgnoreCase("com.sdsmdg.harjot.AZMusic.ACTION_PREV")) {
            try {
