package com.sdsmdg.harjot.AZMusic.fragments.AboutFragment;
...
public class AboutFragment extends Fragment {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        if (SplashActivity.tf4 != null) {
            ...
            fragTitle.setTypeface(com.sdsmdg.harjot.AZMusic.activities.SplashActivity.tf4);
        }
        ...
        if (HomeActivity.isReloaded) {
            ...
            bottomMarginLayout.getLayoutParams().height = com.sdsmdg.harjot.AZMusic.utilities.CommonUtils.dpTopx(65, getContext());
        }
